...
The bundled *P. lividus* example data provides real pixel-space tracks recorded
by a webcam mounted above a circular arena. We load the first trial and apply the
