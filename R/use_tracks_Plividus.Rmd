...
Find each trial and get data, (i) frame no (ii - v) coords for centre and stimulus (vi) last frame, (vii - viii) normalised stimulus centre (ix) theta in rads (anticlock, zero=0) (x) rho in pixels 
