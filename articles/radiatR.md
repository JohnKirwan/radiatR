...
demonstrate the import workflow. Landmark files (`_point01.txt`) record
two pixel-space reference points per trial (arena centre and target
location on the arena wall); track files (`_point02.txt`) contain the
full xy trajectory.
