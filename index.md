...
> <https://johnkirwan.github.io/radiatR/app/> has been retired — that
> URL now redirects to the shinyapps.io app above. The WASM build
> shipped the whole R runtime to the browser, so it loaded slowly and
> needed cross-origin isolation that GitHub Pages can’t provide, making
> it unreliable. The server-side shinyapps.io deploy replaces it.
