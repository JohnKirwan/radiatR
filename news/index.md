...
- The stacked-dots display now sits just inside the unit circle (the
...
- The Rayleigh critical circle is now part of the shared plot spec, so
  ...
  reproduce.
- The mean-direction confidence interval and the V-test decision
  boundary are now part of the shared plot spec too, drawn by the
  exported
